 ...
 *         		java -cp Section-03-Selecting-The-JVM.jar
 *         com.sid.tutorials.performance.tuning.memory.management.Section03SelectingTheJVM 10
 *         
 *         		java -client -cp Section-03-Selecting-The-JVM.jar 
 *         com.sid.tutorials.performance.tuning.memory.management.Section03SelectingTheJVM 10
 *         </pre>
 */
public class Section03SelectingTheJVM {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Time taken to start the application using duration : "
